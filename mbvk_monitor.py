...
def extract(data: Dict) -> Dict:
    ...
    def g(*keys):
        for k in keys:
            if k in data and data[k] is not None:
                return data[k]
            # propertyAddress: lista, az első elem a releváns
    ...
    # Cím összerakása – a JSON mezőnevei alapján
    cim_parts = []
